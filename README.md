...
- **Specification (`HEITOR_LIBRARY.pks`)**: Defines the public interface for the package.
- **Body (`HEITOR_LIBRARY.pkb`)**: Contains the implementation of the package's functions.
